...
module.exports.register = async (req, res) => {
    ...
    if (existEmail) {
        ...
        const user = new User({
            ...
            token: generateHelper.generateRadomString(30)
        });
...
module.exports.forgot = async (req, res) => {
    ...
    const html = `
    Mã OTP để lấy lại mật khẩu của bạn là <b>${otp}</b> (Sử dụng trong vòng 3 phút).
    Vui lòng không chía sẻ mã OTP này với bất kỳ ai.
    `;
